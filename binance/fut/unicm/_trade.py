...
from binance.constant import _UNI_CM_VER_
...
def new_order_test(self, symbol: str, side: str, type: str, **kwargs):
    ...
    POST /{_UNI_CM_API_}/{_UNI_CM_VER_}/order/test
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/order/test"
...
def new_order(self, symbol: str, side: str, type: str, **kwargs):
    ...
    POST /{_UNI_CM_API_}/{_UNI_CM_VER_}/order
    ...
    check_required_parameters([[symbol, "symbol"], [side, "side"], [type, "type"]])
    params = {"symbol": symbol, "side": side, "type": type, **kwargs}
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/order"
    return self.sign_request("POST", url_path, params)
...
def cancel_order(self, symbol: str, **kwargs):
    ...
    DELETE /{_UNI_CM_API_}/{_UNI_CM_VER_}/order
...
def modify_order(self, symbol: str, **kwargs):
    ...
    PUT /{_UNI_CM_API_}/{_UNI_CM_VER_}/order
...
def cancel_open_orders(self, symbol: str, **kwargs):
    ...
    DELETE api/{_UNI_CM_VER_}/openOrders
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/openOrders"
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("DELETE", url_path, payload)
...
def get_order(self, symbol, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/order
...
def cancel_and_replace(
    ...
    POST /{_UNI_CM_API_}/{_UNI_CM_VER_}/order/cancelReplace
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/order/cancelReplace"
    return self.sign_request("POST", url_path, params)
...
def get_open_orders(self, symbol=None, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/openOrders
...
def get_orders(self, symbol: str, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/allOrders
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/allOrders"
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", url_path, payload)
...
def commission_rate(self, symbol: str, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/commisionRate
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/commissionRate"
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", url_path, payload)
...
def new_oco_order(
    ...
    **kwargs
    ...
    POST /{_UNI_CM_API_}/{_UNI_CM_VER_}/order/oco
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/order/oco"
    return self.sign_request("POST", url_path, params)
...
def cancel_oco_order(self, symbol, **kwargs):
    ...
    DELETE /{_UNI_CM_API_}/{_UNI_CM_VER_}/orderList
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/orderList"
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("DELETE", url_path, payload)
...
def get_oco_order(self, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/orderList
...
def get_oco_orders(self, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/allOrderList
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/allOrderList"
    return self.sign_request("GET", url_path, {**kwargs})
...
def get_oco_open_orders(self, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/openOrderList
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/openOrderList"
    return self.sign_request("GET", url_path, {**kwargs})
...
def account(self, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/account
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/account"
    return self.sign_request("GET", url_path, {**kwargs})
...
def user_trades(self, symbol: str, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/myTrades
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/userTrades"
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", url_path, payload)
...
def get_order_rate_limit(self, **kwargs):
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/rateLimit/order
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/rateLimit/order"
    return self.sign_request("GET", url_path, {**kwargs})
...
def query_prevented_matches(self, symbol: str, **kwargs):
    ...
    * symbol + orderId + fromPreventedMatchId + limit
    ...
    GET /{_UNI_CM_API_}/{_UNI_CM_VER_}/myPreventedMatches
    ...
    url_path = f"/{_UNI_CM_API_}/{_UNI_CM_VER_}/myPreventedMatches"
